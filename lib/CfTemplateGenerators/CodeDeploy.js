...
function buildFnDeploymentGroup({ codeDeployAppName, codeDeployRole, deploymentSettings = {} }) {
  ...
  if (typeof codeDeployRole != 'undefined') {
    Object.assign(deploymentGroup.Properties, { ServiceRoleArn: codeDeployRole });
  } else {
    Object.assign(deploymentGroup.Properties, { ServiceRoleArn: lookupRole });
  }
