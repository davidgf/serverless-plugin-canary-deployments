...
function buildUpdatePolicy({ codeDeployApp, deploymentGroup, afterHookName, beforeHookName, afterHook, beforeHook }) {
  const updatePolicy = {
    CodeDeployLambdaAliasUpdate: {
      ApplicationName: { Ref: codeDeployApp },
      AfterAllowTrafficHook: afterHookName || { Ref: afterHook },
      BeforeAllowTrafficHook: beforeHookName || { Ref: beforeHook },
