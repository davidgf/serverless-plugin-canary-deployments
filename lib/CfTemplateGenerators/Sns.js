...
function replaceSubscriptionFunctionWithAlias(subscription, functionAlias, functionName) {
  ...
  const newProperties = Object.assign({}, subscription.Properties, { Endpoint: newEndpoint});
